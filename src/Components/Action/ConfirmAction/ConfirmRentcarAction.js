...
import './ConfirmRentcarAction.css'
...
export const ConfirmRentcarAction = ({id}) => {
  ...
  return (
    <td id='Button'>
        <a href={'rentcar/info/' + id.original._id} id='Info'><AiFillInfoCircle size={40} />&nbsp; <div>ดูข้อมูล</div></a>
        <>
